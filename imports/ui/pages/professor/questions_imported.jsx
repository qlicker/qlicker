...
class _QuestionsFromImport extends Component {
...
export const QuestionsFromImport = createContainer(props => {
  const handle = Meteor.subscribe('questions.imported')
