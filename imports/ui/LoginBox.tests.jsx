...
if (Meteor.isClient) {
  describe('<LoginBox />', () => {
    ...
    it('should render', () => {
      ...
      expect(loginBox.hasClass('ql-login-box')).to.equal(true)
    ...
    it('should show additional signup fields', () => {
      ...
      login.find('.ql-switch-form-button').at(0).simulate('click')
    ...
    it('should update state on input change', () => {
      ...
      loginBox.find('.ql-switch-form-button').at(0).simulate('click')
